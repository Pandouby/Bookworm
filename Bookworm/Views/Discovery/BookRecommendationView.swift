    ...
    private func generateMockRecommendations() {
        ...
        let mockBooks = [
            CompleteBookData(
                ...
                userDetails: UserBookDetails(editionKey: "ME1", addedDate: Date(), userRating: 0.0, isFavorite: false, status: .wantToRead, startDate: Date(), endDate: Date(), notes: "")
            ),
            CompleteBookData(
                ...
                genres: [.fiction, .science],
                userDetails: UserBookDetails(editionKey: "ME2", addedDate: Date(), userRating: 0.0, isFavorite: false, status: .wantToRead, startDate: Date(), endDate: Date(), notes: "")
            ),
            CompleteBookData(
                ...
                genres: [.fiction],
                userDetails: UserBookDetails(editionKey: "ME3", addedDate: Date(), userRating: 0.0, isFavorite: false, status: .wantToRead, startDate: Date(), endDate: Date(), notes: "")
            ),
            CompleteBookData(
                ...
                genres: [.fiction],
                userDetails: UserBookDetails(editionKey: "ME4", addedDate: Date(), userRating: 0.0, isFavorite: false, status: .wantToRead, startDate: Date(), endDate: Date(), notes: "")
            )
        ]
